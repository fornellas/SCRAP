 ...
 *                     - Added support for multi-thread calls (POSIX only)
 *                     - Misc bug fixes
...
/* get AVI_errno pointer */
long * get_AVI_errno(void);
/* The following macro variable indicates the kind of error */
#define AVI_errno (*get_AVI_errno())

/* AVI_errno error codes */
